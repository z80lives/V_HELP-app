...
import { NewOfferInVolunteer } from '../models/new-offer-in-volunteer';
...
export class VolunteerOfferControllerService extends BaseService {
  ...
  /**
   * Path part for operation volunteerOfferControllerFind
   */
  ...
  /**
   * Path part for operation volunteerOfferControllerPatch
   */
  static readonly VolunteerOfferControllerPatchPath = '/volunteers/{id}/offers';
